...
<div class="row">
	...
	<div class="col-md-6">
		<a class="btn btn-outline-primari" href="backoffice/materiales?op=<%=BackofficeMateriales.OP_MOSTRAR_FORMULARIO%>">Crear Nuevo</a>
	</div> 
...
<table class="tabla table table-striped table-bordered" style="width:100%">
   ...
   <tbody>
	...
	<c:forEach items="${materiales}" var="material">
		<tr>			
			<td>
				<a href="backoffice/materiales?id=${material.id}&op=<%=BackofficeMateriales.OP_MOSTRAR_FORMULARIO%>">${material.nombre}</a>
			</td>		
